    ...
    <div class="col-lg-7">
      ...
      <div class="content-section reveal">
        ...
        <div class="icon-card-grid">
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-house"></i></div><div class="ic-content"><div class="ic-title">3 Bedroom Cottage</div><div class="ic-desc">Spacious & private</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-snow"></i></div><div class="ic-content"><div class="ic-title">1 Master Bedroom</div><div class="ic-desc">With AC & attached bath</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-wind"></i></div><div class="ic-content"><div class="ic-title">2 Standard Bedrooms</div><div class="ic-desc">Non-AC, breezy & comfortable</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-droplet"></i></div><div class="ic-content"><div class="ic-title">1 Common Washroom</div><div class="ic-desc">Clean & fully equipped</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-tv"></i></div><div class="ic-content"><div class="ic-title">Spacious Hall Area</div><div class="ic-desc">Perfect for gathering</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-cup-hot"></i></div><div class="ic-content"><div class="ic-title">Dining Area</div><div class="ic-desc">Enjoy meals together</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-cup-straw"></i></div><div class="ic-content"><div class="ic-title">Sitout Area</div><div class="ic-desc">Relax with a view</div></div></div>
        </div>
      </div>
      ...
      <div class="content-section reveal">
        ...
        <div class="icon-card-grid">
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-water"></i></div><div class="ic-content"><div class="ic-title">Private Pool Area</div><div class="ic-desc">Exclusive access</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-tree"></i></div><div class="ic-content"><div class="ic-title">Lawn Area</div><div class="ic-desc">Lush greenery</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-car-front"></i></div><div class="ic-content"><div class="ic-title">Private Parking</div><div class="ic-desc">Safe & secure</div></div></div>
          <div class="icon-card"><div class="ic-icon"><i class="bi bi-stars"></i></div><div class="ic-content"><div class="ic-title">Open Event Space</div><div class="ic-desc">For celebrations</div></div></div>
        </div>
      </div>
      ...
      <div class="content-section reveal">
        ...
        <div class="icon-card-grid">
          <div class="icon-card"><div class="ic-icon">🚣</div><div class="ic-content"><div class="ic-title">Kayaking</div></div></div>
          <div class="icon-card"><div class="ic-icon">🎣</div><div class="ic-content"><div class="ic-title">Fishing</div></div></div>
          <div class="icon-card"><div class="ic-icon">🚤</div><div class="ic-content"><div class="ic-title">Boating</div></div></div>
          <div class="icon-card"><div class="ic-icon">🍖</div><div class="ic-content"><div class="ic-title">Grilling / BBQ</div></div></div>
          <div class="icon-card"><div class="ic-icon">🔥</div><div class="ic-content"><div class="ic-title">Campfire</div></div></div>
          <div class="icon-card"><div class="ic-icon">💨</div><div class="ic-content"><div class="ic-title">Sheesha / Hookah</div><div class="ic-desc">6 available</div></div></div>
        </div>
      </div>
      ...
      <div class="booking-sticky reveal">
        <div class="booking-card">
          ...
          <div class="pricing-info">
            <div class="pi-row"><span class="pi-label">Weekend (Up to 10 Guests)</span><span class="pi-val">₹12,000</span></div>
            <div class="pi-row"><span class="pi-label">Weekday (5 Guests)</span><span class="pi-val">₹8,000</span></div>
            <div class="pi-row"><span class="pi-label">Weekday (6 Guests)</span><span class="pi-val">₹8,500</span></div>
            <div class="pi-row"><span class="pi-label">Weekday (7 Guests)</span><span class="pi-val">₹9,000</span></div>
            <div class="pi-row"><span class="pi-label">Weekday (Up to 10)</span><span class="pi-val">₹11,000</span></div>
          ...
          <form action="{{ route('bookings.store') }}" method="POST" id="bk-form" onsubmit="handleBookingSubmit(event)">
            ...
            <div style="margin-bottom:1.5rem;">
              ...
              <div id="amenities-list" style="display:flex;flex-direction:column;gap:.75rem;">
                ...
                @php
                  $normalizedAmenityName = strtolower(trim($amenity->name));
                  $hideParticipantPicker = in_array($normalizedAmenityName, ['grilling', 'camp fire']);
                @endphp
                <div class="amenity-card" data-amenity-id="{{ $amenity->id }}">
                  ...
                  <div class="amenity-top">
                    <label class="amenity-label">
                      <input
                        type="checkbox"
                        class="amenity-selector"
                        data-amenity-id="{{ $amenity->id }}"
                        data-amenity-name="{{ $amenity->name }}"
                        data-amenity-price="{{ $amenity->price }}"
                        data-amenity-type="{{ $amenity->pricing_type }}"
                        name="amenities[{{ $amenity->id }}][selected]"
                        value="1"
                      />
                      <span>{{ $amenity->name }}</span>
                    </label>
                    <div class="amenity-price-label">
                      @if($amenity->pricing_type === 'per_person' && ! $hideParticipantPicker)
                  ...
                  {{-- Participant picker (per_person only) --}}
                  @if($amenity->pricing_type === 'per_person' && ! $hideParticipantPicker)
                  <div class="amenity-participants">
                    <div class="picker-label">Persons participating</div>
                    <div class="picker-row">
                      <div class="counter-wrap">
                        <button type="button" class="counter-btn minus-btn" disabled>−</button>
                        <input
                          type="number"
                          class="counter-input amenity-participants-input"
                          name="amenities[{{ $amenity->id }}][participants]"
                          min="1"
                          value="1"
                          readonly
                        />
                      ...
                      <span class="subtotal-pill">₹{{ number_format($amenity->price, 2) }}</span>
                    </div>
                  </div>
                  @endif
                ...
                @empty
                <div style="font-size:.9rem;color:#888;">No amenities configured for this property yet.</div>
                @endforelse
            ...
            <div id="booking-summary" style="margin-top:1.5rem;padding:1.2rem;border:1px solid rgba(250,135,62,.18);border-radius:16px;background:#fff;">
              <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.5rem;margin-bottom:1rem;">
                ...
                <div style="text-align:right;min-width:150px;">
                  ...
                  <div id="summary-base-price" style="font-size:1.25rem;font-weight:700;color:#e06828;">₹{{ number_format($property->price ?: 0, 2) }}</div>
                </div>
              </div>
              <div id="summary-amenities-list" style="margin-bottom:1rem;color:#444;">
                <div style="font-weight:700;margin-bottom:.6rem;color:#333;">Extra Amenities</div>
                <div id="summary-amenities-empty" style="color:#777;font-size:.95rem;">Choose amenities to see extra charges.</div>
              </div>
              <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:.75rem;border-top:1px solid rgba(229,231,235,.8);padding-top:1rem;">
                <div style="font-size:.95rem;color:#555;">Total extra amount</div>
              ...
              <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:.75rem;margin-top:.8rem;">
                ...
                <div id="summary-grand-total" style="font-size:1.35rem;font-weight:800;color:#b45309;">₹{{ number_format($property->price ?: 0, 2) }}</div>
              </div>
            </div>

            <button type="submit" class="btn-book-submit" style="margin-top:1.5rem;">Book Now</button>
            <div class="text-center my-3" style="font-size:.8rem;color:var(--text-muted);font-weight:600;letter-spacing:.1em;text-transform:uppercase">OR</div>
            <a href="/chatbot" target="_blank" class="btn-wa-alt">
              <i class="bi bi-chat-left-text"></i> Chat with us
            </a>
            <div class="contact-panel" style="margin-top:1.2rem;padding:1rem;border:1px solid rgba(0,0,0,.08);border-radius:12px;background:#fafafa;font-size:.95rem">
...
function getGuestCount() {
  return Math.max(1, parseInt(document.querySelector('input[name="guests"]')?.value || '1'));
}

function updateSubtotal(card, price, qty) {
  const pill = card.querySelector('.subtotal-pill');
  if (pill) pill.textContent = `₹${(price * qty).toFixed(2)}`;
}
